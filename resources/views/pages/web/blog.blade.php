            ...
            <div class="container pt-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item fw-500 active" aria-current="page">Blog</li>
                    </ol>
                </nav>
            </div>
        </section>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-lg-12">
                                        <img class="card-img-top rounded-0 w-100 h-100"
                                            src="{{ $post['thumbnail'] }}" alt="blog thumbnail" />
                                    </div>
                                    <div class="col-12 col-sm-6 col-lg-12">
                                        <div class="card-body p-0 p-2">
                                            <h3 class="fw-600 fs-25 text-dark text-ellipsis w-100 m-0">{{ $post['title'] }}</h3>
                                            ...
                                            <a href="{{ env('APP_URL') }}/blog/category/{{ $post['id'] }}" class="btn mt-1 btn-sm rounded-0 btn-outline-primary"
                                                alt="read more">Read
                                                More</a>
                                        </div>
                                    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-6 col-lg-5">
                    <svg class="hero-resize" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" width="1009.54" height="789.93"
                        ...
                        <title>empty</title>
                        <ellipse cx="354.13" cy="741.27" rx="176.1" ry="33.36" fill="#45526c" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-95.23 -55.03)" fill="#45526c" opacity="0.1" />
                        <path
                        ...
                        <path d="M394.38,769.53s-23.78,18.5-19.77,19S394.38,769.53,394.38,769.53Z"
                            transform="translate(-95.23 -55.03)" opacity="0.1" />
                        <polygon points="330.96 347.33 407.96 334.8 407.96 407.7 334.8 403.87 330.96 347.33"
                            fill="#45526c" />
                        <polygon points="330.96 347.33 407.96 334.8 407.96 407.7 334.8 403.87 330.96 347.33"
                            opacity="0.05" />
                        <polygon points="407.96 334.8 500.3 341.71 495.19 405.15 407.96 407.7 407.96 334.8"
                            fill="#45526c" />
                        ...
                        <polygon points="303.08 368.31 330.96 347.33 424.84 353.73 411.02 377.01 303.08 368.31" fill="#fff"
                            opacity="0.1" />
                        <polygon points="500.3 341.71 424.84 353.73 449.4 375.73 530.23 362.17 500.3 341.71"
                            fill="#45526c" />
                        ...
                        <path
                            ...
                            transform="translate(-95.23 -55.03)" fill="#45526c" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-95.23 -55.03)" fill="#45526c" />
                        <ellipse cx="698.97" cy="716.3" rx="26.93" ry="4.55" fill="#45526c" opacity="0.1" />
                        <ellipse cx="600.8" cy="785.38" rx="26.93" ry="4.55" fill="#45526c" opacity="0.1" />
                        <ellipse cx="93.14" cy="749.99" rx="26.93" ry="4.55" fill="#45526c" opacity="0.1" />
                        <ellipse cx="805.06" cy="780.83" rx="26.93" ry="4.55" fill="#45526c" opacity="0.1" />
                        <ellipse cx="833.1" cy="723.1" rx="40.21" ry="6.8" fill="#45526c" />
                        <path
                ...
                <div class="col-12 col-md-6 col-lg-7 mt-3 bg-light py-2">
                    <h2 class="fs-30 fw-600 text-dark">
                        Sorry, there are no blog posts available for you to read at this time.
                    </h2>
                    <a href="{{ env('APP_URL') }}/note/physics"
                        class="btn btn-outline-primary rounded-0 border-1 fw-400 fs-15 mt-3">Go To Home Page</a>
                </div>
            </div>
        </div>
    </section>
