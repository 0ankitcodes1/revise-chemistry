        ...
        <div class="container pt-4">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item fw-500 active" aria-current="page">Sign Up</li>
                </ol>
            </nav>
        </div>
    </section>
                ...
                <div class="col-12 col-md-6 col-lg-7 py-3 bg-light">
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-6 mb-3">
                            ...
                            <input type="text" class="form-control rounded-0 border-style-dashed border-3 bg-light"
                                id="firstNameField" aria-describedby="firstNameField">
                            <div id="firstNameField-msg" class="form-text text-danger"></div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-6 mb-3">
                            <label for="emailField" class="form-label fw-600 fs-15 text-dark">Last Name</label>
                            <input type="text" class="form-control rounded-0 border-style-dashed border-3 bg-light"
                                id="lastNameField" aria-describedby="lastNameField">
                            <div id="lastNameField-msg" class="form-text text-danger"></div>
                        </div>
                        <div class="col-12 mb-3">
                            <label for="emailField" class="form-label fw-600 fs-15 text-dark">Email</label>
                            <input type="email" class="form-control rounded-0 border-style-dashed border-3 bg-light"
                                id="emailField" aria-describedby="emailField">
                            <div id="emailField-msg" class="form-text text-danger"></div>
                        </div>
                        <div class="col-12 col-lg-6 mb-3">
                            <label for="passwordField" class="form-label fw-600 fs-15 text-dark">Password</label>
                            <input type="password" class="form-control rounded-0 border-style-dashed border-3 bg-light"
                                id="passwordField" aria-describedby="passwordField">
                            <div id="passwordField-msg" class="form-text text-danger"></div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <label for="passwordConfirmationField" class="form-label fw-600 fs-15 text-dark">Password
                                Confirmation</label>
                            <input type="password" class="form-control rounded-0 border-style-dashed border-3 bg-light"
                                id="passwordConfirmationField" aria-describedby="passwordConfirmationField">
                            <div id="passwordConfirmationField-msg" class="form-text text-danger"></div>
                        </div>
                        <div class="col-12 btn-group">
                            <button id="signup-student-btn" type="submit"
                                class="btn btn-outline-dark rounded-0 fw-500 px-3 mt-4 me-3">Sign Up</button>
                            <!--
                                <a href="#" class="btn btn-outline-dark rounded-0 fw-500 mt-4">
                                    <svg class="me-2" width="20" height="20" enable-background="new 0 0 128 128" id="Social_Icons" version="1.1"
                        ...
                        <div class="col-12 mt-4">
                            <a href="{{ env('APP_URL') }}/login"
                                class="text-dark fw-500 fs-15 text-decoration-none">Already have account then <strong>Login
                                    Now</strong></a>
                        </div>
                    </div>
                </div>
