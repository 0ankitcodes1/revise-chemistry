<form wire:submit.prevent="save">
    ...
    <div class="col-12 mb-3">
        ...
        <input type="text" class="form-control rounded-0 border-style-dashed border-3 bg-light @error('video_chapter') is-invalid @enderror"
    ...
    <div class="col-12 mb-3">
        ...
        <input wire:model="video_subchapter" type="text" class="form-control rounded-0 border-style-dashed border-3 bg-light @error('video_subchapter') is-invalid @enderror"
    ...
    <div class="col-8 mb-3">
        ...
        <select wire:model="video_category" id="videoCategoryField" class="form-select rounded-0 border-style-dashed border-3 bg-light @error('video_category') is-invalid @enderror"
    ...
    <div class="mb-3">
        ...
        <input wire:model="photo" type="file" class="form-control rounded-0 border-style-dashed border-3 bg-light @error('photo') is-invalid @enderror" id="videoFileField">
        @error('photo')
