<section class="bg-light">
    <div class="container">
        <div class="row align-items-center">
            ...
            <form class="col-12 col-md-6 col-lg-7 py-3 bg-light" wire:submit.prevent="save">
                @if ($userrole == 0)
                    <h3 class="mb-3">Admin Login Panel</h3>
                @else
                ...
                <div>
                    <div class="mb-4">
                        <label for="emailStudentField" class="form-label fw-600 fs-15 text-dark">Email
                            address</label>
                        <input wire:model="email" type="email"
                            class="form-control rounded-0 border-style-dashed border-3 bg-light @error('email') border-danger @enderror"
                            id="emailStudentField" aria-describedby="emailStudentField">
                        @error('email')
                            <div id="emailStudentField-msg" class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        @error('password')
                            <div id="passwordStudentField-msg" class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    @if ($userrole == 0)
                        <div>
                            <a href="{{ env('APP_URL') }}/admin/forgot-password"
